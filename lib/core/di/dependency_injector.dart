...
import 'package:adda_time/data/repository/auth/auth_repository.dart';
import 'package:adda_time/data/repository/chat/chat_repository.dart';
import 'package:adda_time/data/repository/connectivity/connectivity_repository.dart';
...
void injectionSetup() {
  ...
  getIt.registerLazySingleton<AiApiClient>(() => AiApiClient());
