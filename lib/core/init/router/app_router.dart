...
import 'package:adda_time/core/init/router/navigation_state_codec.dart';
import 'package:adda_time/core/init/router/custom_page_builder_widget.dart';
import 'package:adda_time/presentation/blocs/phone_number_sign_in/phone_number_sign_in_state.dart';
import 'package:adda_time/presentation/views/bottom_tab/bottom_tab_view.dart';
import 'package:adda_time/presentation/views/dashboard/dashboard_view.dart';
import 'package:adda_time/presentation/views/chat/chat_view.dart';
import 'package:adda_time/presentation/views/create_chat/create_chat_view.dart';
import 'package:adda_time/presentation/views/landing/landing_view.dart';
import 'package:adda_time/presentation/views/onboarding/onboarding_view.dart';
import 'package:adda_time/presentation/views/profile/profile_view.dart';
import 'package:adda_time/presentation/views/sign_in/sign_in_view.dart';
import 'package:adda_time/presentation/views/sms_verification/sms_verification_view.dart';
import 'package:adda_time/presentation/views/ai_chat/ai_chat_view.dart';
...
class AppRouter {
  ...
  GoRoute get _aiChatRoute => GoRoute(
        path: RouterEnum.aiChatView.routeName,
