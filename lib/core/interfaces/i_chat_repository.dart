...
abstract class IChatRepository {
  ...
  /// Sends a text message to the selected channel. Implementations may
  /// encrypt the message payload before sending.
  Future<Either<ChatFailureEnum, Unit>> sendTextMessage({
    required String channelId,
    required String text,
  });

  /// Attempts to decrypt a received `Message` if it contains E2EE payloads.
  /// Returns the decrypted plaintext or null if decryption is not possible.
  Future<String?> tryDecryptMessage(Message message);
}
